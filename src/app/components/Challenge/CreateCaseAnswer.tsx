...
interface CreateCaseAnswerProps {
    onClose: () => void;
    challenge: Challenge;
}
...
const CreateCaseAnswer: React.FC<CreateCaseAnswerProps> = React.forwardRef(
    ({ onClose, challenge }) => {
        ...
        const { mutate, isLoading } = useMutation(
            (data) =>
                axios({
                    method: 'POST',
                    url: `/api/question/case-study/${challenge._id}`,
                    data,
                }),
            {
                onSuccess: () => {
...
export default CreateCaseAnswer;
